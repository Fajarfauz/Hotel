...
const RoomTable = async () => {
  ...
  if (!rooms?.length) return <p>Room Not Found</p>;
  ...
  return (
    <div className="bg-white p-4 mt-5 shadow-sm">
      <table className="w-full divide-y divide-gray-200">
        <thead>
          <tr>
            <th className="px-6 py-3 w-32 font-bold text-gray-700 uppercase text-left">
              Image
            </th>
            <th className="px-6 py-3 font-bold text-gray-700 uppercase text-left">
              Room Name
            </th>
            <th className="px-6 py-3 font-bold text-gray-700 uppercase text-left">
              Price
            ...
            <th className="px-6 py-3 font-bold text-gray-700 uppercase">
              Action
            </th>
          </tr>
        </thead>
