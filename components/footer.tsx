  ...
  return (
    <footer className="bg-gray-900">
        ...
        <div className="grid md:grid-cols-3 gap-7">
          <div className="">
            ...
            <p className="text-gray-400">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum natus assumenda sit consectetur in. Consequatur?
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <form action="" className="mt-5">
              ...
              <button className="bg-orange-400 p-3 font-bold text-bold text-white w-full text-center rounded-sm hover:bg-orange-500">
                Subscribe
              </button>
            </form>
          </div>
      ...
      <div className="max-w-screen-xl mx-auto px-4 border-t border-gray-500 py-8 text-center text-base text-gray-500">
        &copy; Copyright 2025 | Fajar Fauz | All Right Reserved
      </div>
    </footer>
  );
};
